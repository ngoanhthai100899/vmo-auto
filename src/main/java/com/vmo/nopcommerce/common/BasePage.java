...
//
    ...
    public void waitForElementVisibleShortTime(WebDriver driver, String locator) {
        explicit = new WebDriverWait(driver, Duration.ofSeconds(shortTimeOut));
        explicit.until(ExpectedConditions.visibilityOfElementLocated(getXPathLocator(locator)));
    }
    ...
    public void waitForElementPresence(WebDriver driver, String locator) {
        explicit = new WebDriverWait(driver, Duration.ofSeconds(longTimeOut));
        explicit.until(ExpectedConditions.presenceOfElementLocated(getXPathLocator(locator)));
    ...
    public void waitForElementClickable(WebDriver driver, String locator, String... params) {
        explicit = new WebDriverWait(driver, Duration.ofSeconds(longTimeOut));
        explicit.until(ExpectedConditions.elementToBeClickable(getXPathLocator(getDynamicLocator(locator, params))));
    ...
    public ArrayList<String> getTextListFromElements(WebDriver driver, String locator) {
        ArrayList<String> productList = new ArrayList<>();
        List<WebElement> elementList = driver.findElements(By.xpath(locator));
        for (WebElement we : elementList) {
            productList.add(we.getText());
        }
    ...
    public ArrayList<String> getFirstCharFromTextList(WebDriver driver, String locator) {
        ArrayList<String> productList = new ArrayList<>();
        List<WebElement> elementList = driver.findElements(By.xpath(locator));
        for (WebElement we : elementList) {
            productList.add(we.getText());
        ...
        ArrayList<String> textList = new ArrayList<>();
        for (String s : productList) {
            textList.add(s.substring(0, 1));
        }
        return textList;
    }

    public ArrayList<String> setTextListFromZToA(WebDriver driver, String locator) {
        ArrayList<String> productList = new ArrayList<>();
        List<WebElement> elementList = driver.findElements(By.xpath(locator));
        for (WebElement we : elementList) {
            productList.add(we.getText());
