...
public class ExcelUtil {
    public static final String       testDataExcelFileName = "Test data.xlsx"; //Global test data excel file
    public static final String       currentDir            = System.getProperty("C:\\Users\\Ngo Anh Thai\\vmo-fresher");  //Main Directory of the project
